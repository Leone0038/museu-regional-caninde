            ...
            <section className="flex-1 flex justify-center items-center text-amber-50">
                <div className="flex flex-col gap-16 p-6 text-xl leading-normal">
                    <p className="p-8 shadow bg-gray-950/80 rounded-2xl">
                        ...
                        um espaço simbólico para o turismo de romaria.
                    </p>
                    ...
                    <p className="p-8 shadow bg-gray-950/80 rounded-2xl">
                        <strong>Âncora do Turismo:</strong> Concentra
                        informações culturais valiosas, sendo um atrativo
                        fundamental para visitantes que desejam conhecer a vida
                        da cidade.
                    </p>
                </div>
            </section>
            <div className="fixed inset-0 -z-10 bg-[url(/images/about-page-portrait.webp)] md:bg-[url(/images/about-page-landscape.webp)] bg-center bg-cover bg-fixed"></div>
        </>
    );
}
